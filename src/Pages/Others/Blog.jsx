...
const Blog = () => {
    ...
    return (
        <div className=" p-8">
            <div className='h-[600px] w-[1440px] mb-10' style={{ backgroundImage: `url(${img})` }}>
                <div className='pt-96'>
                    <h1 className='text-5xl font-bold text-black text-center '>Your Journey to Educational Event <br /> Excellence Begins Here! <br /><span className='text-6xl font-bold text-blue-700 mt-3'>Edu Event</span></h1>
                </div>
            </div>
            <h1 className="text-3xl text-blue-700 font-bold mb-4">Welcome to the Edu Event Blog</h1>
            ...
            <h2 className="text-2xl font-bold text-blue-700 mt-8 mb-4">Latest Posts</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {posts.map((post, index) => (
                    <div key={index} className="bg-white rounded-lg shadow-lg p-6 flex items-center" >
                        <div className="flex-shrink-0">
                            <img src={post.imageUrl} alt={post.title} className="w-64 h-48 object-cover rounded-lg" />
                        </div>
                        <div className="ml-4">
                            <h3 className="text-blue-700 text-xl font-semibold mb-2">{post.title}</h3>
